...
This repository provides a slab allocator that may be instantiated on top of either a rust-managed or user-managed memory region.

This abstraction is used in the Nanvix operating system to construct complex memory allocators.
